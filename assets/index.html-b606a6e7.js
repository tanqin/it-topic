import{_ as t,M as p,p as c,q as i,R as n,t as a,N as l,a1 as s}from"./framework-96b046e1.js";const o={},u=s(`<h1 id="java" tabindex="-1"><a class="header-anchor" href="#java" aria-hidden="true">#</a> Java</h1><details class="custom-container details"><summary>什么是 JDBC？为什么需要 JDBC？</summary><p>JDBC(Java Database Connectivity) Java 数据库连接。 它是一个接口，由对应的数据库厂商完成接口实现类，该实现类就是所说的驱动。 由于每个厂商底层代码实现不同，切换数据库需要改变 Java 代码，成本过大，所以需要 JDBC 进行调和，实现一套代码，操作不同的关系型数据库。 使用 mysql JDBC 驱动示例，涉及到了事务处理：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>math<span class="token punctuation">.</span></span><span class="token class-name">BigDecimal</span></span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">JDBCDemo</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><details class="custom-container details"><summary>isNotBlank 与 isNotEmpty 的区别？</summary><p>isNotBlank 对空白字符判断结果为 false，isNotEmpty 对空白字符判断结果为 true。</p></details><details class="custom-container details"><summary>tinyint(1) 与 char(1) 占用字节数一样吗？如何考虑选用哪一个？</summary><p>tinyint(1) 和 char(1) 都是占用 1 个字节空间。 在一次查询大量数据时，tinyint(1) 比 char(1) 更快。</p></details>`,4),r={class:"custom-container details"},d=n("summary",null,"位运算符",-1),m={href:"https://www.cnblogs.com/SunArmy/p/9837348.html",target:"_blank",rel:"noopener noreferrer"},k=s("<p><strong>与运算符(&amp;)</strong></p><p>以 4&amp;7 为例：</p><p>4 ： 0000 0100</p><p>7 ： 0000 0111</p><p>值(4)：0000 0100</p><p>总结：运算时，一假(0)则假(0)。</p><p><strong>或运算符(|)</strong></p><p>以 5|9 为例：</p><p>5 ： 0000 0101</p><p>9 ： 0000 1001</p><p>值(13)：0000 1101</p><p>总结：运算时，一真(1)则真(1)。</p><p><strong>左移运算(&lt;&lt;)</strong></p><p>12&lt;&lt;3 = 96</p><p>8&lt;&lt;4 = 128</p><p>总结：所有位向左移动，右侧空位补 0。</p><p>公式：M &lt;&lt; n = M * 2^n</p><p><strong>右移运算(&gt;&gt;)</strong></p><p>12 &gt;&gt; 2 = 3</p><p>-8 &gt;&gt; 2 = -2</p><p>总结：所有位向右移动，左侧空位，负数补 1，正数补 0。</p><p>公式：M &gt;&gt; n = M / 2^n</p>",22),v=s(`<details class="custom-container details"><summary>求 -123 的二进制数</summary><p>负数的二进制求法:</p><p>负数的二进制一般通过正数反推导出，即（正数二进制 -&gt; 取反 -&gt; 补码(加1)），举个例子：</p><p>-123 的二进制计算方法为：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token number">123</span> 的二进制：0111 <span class="token number">1011</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><details class="custom-container details"><summary>SpringBoot 如何整合 MyBatis</summary><ol><li><p>pom.xml 中导入 mybatis 整合包；</p></li><li><p>编写 service 接口、mapper 接口、mapper 接口对应的 xml；</p></li><li><p>application.properties 或 application.yml 添加 mybatis 配置。包括接口路径配置、xml 路径配置；</p></li><li><p>编写 controller 类；</p></li></ol></details><details class="custom-container details"><summary>内连接与外连接的区别</summary><p>内连接：结果集只保留两表中匹配的数据，舍弃了不匹配的数据。</p><p>外连接：结果集除了包含符合连接连接条件的行数据，还包含左表、右表的所有行数据。</p></details>`,4);function b(g,_){const e=p("ExternalLinkIcon");return c(),i("div",null,[u,n("details",r,[d,n("p",null,[a("参考文章："),n("a",m,[a("Java 位运算符 &、|、^、~、<<、>>、>>>"),l(e)])]),k]),v])}const h=t(o,[["render",b],["__file","index.html.vue"]]);export{h as default};
