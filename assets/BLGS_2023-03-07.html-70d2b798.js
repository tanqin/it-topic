...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><hr><h2 id="笔试题" tabindex="-1"><a class="header-anchor" href="#笔试题" aria-hidden="true">#</a> 笔试题</h2><h6 id="算法-求数组的子数组之和的最大值" tabindex="-1"><a class="header-anchor" href="#算法-求数组的子数组之和的最大值" aria-hidden="true">#</a> 算法-求数组的子数组之和的最大值</h6><p>举几个例子：</p><p>数组：[1, -2, 3, 5, -3, 2]应返回：8</p><p>数组：[0, -2, 3, 5, -1, 2]应返回：9</p><p>数组：[-9, -2, -3, -5, -3]应返回：-2，这也是最大子数组的和。</p><details class="custom-container details"><summary>查看答案</summary></details>`,40),d=[n];function r(c,t){return i(),a("div",null,d)}const m=e(l,[["render",r],["__file","BLGS_2023-03-07.html.vue"]]);export{m as default};
